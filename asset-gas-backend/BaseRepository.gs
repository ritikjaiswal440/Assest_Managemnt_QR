  ...
  _dbToObj(sheetName, dbObj) {
    if (sheetName === 'Companies' || sheetName === 'Company_Master') {
      return {
        ...
        nonAmcStart: dbObj['NON_CAMC_Start_Date'] || '',
        NON_CAMC_Start_Date: dbObj['NON_CAMC_Start_Date'] || '',
        nonAmcEnd: dbObj['NON_CAMC_End_Date'] || '',
        NON_CAMC_End_Date: dbObj['NON_CAMC_End_Date'] || '',
    ...
    if (sheetName === 'Assets' || sheetName === 'Asset_Master') {
      return {
        ...
        branch: dbObj['Branch'] || dbObj['Sub_Location'] || '',
        subLocation: dbObj['Branch'] || dbObj['Sub_Location'] || '',
  ...
  _objToDb(sheetName, obj) {
    if (sheetName === 'Companies' || sheetName === 'Company_Master') {
      return {
        ...
        'NON_CAMC_Start_Date': obj.nonAmcStart || obj.NON_CAMC_Start_Date || '',
        'NON_CAMC_End_Date': obj.nonAmcEnd || obj.NON_CAMC_End_Date || '',
    ...
    if (sheetName === 'Assets' || sheetName === 'Asset_Master') {
      return {
        ...
        'Branch': obj.branch || obj.subLocation || '',
        'Sub_Location': obj.branch || obj.subLocation || '',
